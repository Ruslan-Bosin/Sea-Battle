    ...
    <div style={body_div}>
      ...
      <div style={create_field_block}>
        <Card bodyStyle={card_body}>
          <Image style={image} preview={false} src="" width="300px" height="300px" fallback={img_fallback}/>
          <div style={set_size_block}>
            <Text>Размер поля:</Text>
            <InputNumber style={input} size="small" min={2} max={10} defaultValue={fieldSize} onChange={(value) => {setFieldSize(value)}}/>
            <Text>на</Text>
