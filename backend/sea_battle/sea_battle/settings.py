...
ALLOWED_HOSTS = str(os.getenv("DJANGO_HOSTS", "*")).split()

ASGI_APPLICATION = "sea_battle.asgi.application"

CHANNEL_LAYERS = {
    "default": {
        "BACKEND": "channels.layers.InMemoryChannelLayer",  # Используйте InMemoryChannelLayer для отладки
    },
}
...
LOGIN_REDIRECT_URL = "authorisation:signup_done"
